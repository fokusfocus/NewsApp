...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            // which represents a list of items (or newses).
            JSONArray bookArray = responseObject.getJSONArray("results");
            if (responseObject.has("results")) {
                responseObject.getJSONArray("results");
            }
